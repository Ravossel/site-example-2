      ...
      <div className="message-content">
        <div className="message-header">
          ...
          <div className="star-checkbox">
            <input type="checkbox input" id="star-1" />
            <label className="label" htmlFor="star-1">
              <svg
                ...
                className="feather feather-star svg"
              >
    ...
    <div className="message-box">
      ...
      <div className="message-content">
        <div className="message-header">
          ...
          <div className="star-checkbox">
            <input type="checkbox input" id="star-2" />
            <label className="label" htmlFor="star-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
    ...
    <div className="message-box">
      ...
      <div className="message-content">
        <div className="message-header">
          ...
          <div className="star-checkbox">
            <input type="checkbox input" id="star-3" />
            <label className="label" htmlFor="star-3">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
    ...
    <div className="message-box">
      ...
      <div className="message-content">
        <div className="message-header">
          ...
          <div className="star-checkbox">
            <input type="checkbox input" id="star-4" />
            <label className="label" htmlFor="star-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
...
interface MessageBoxesProps {
  role: "ONE" | "TWO" | "THREE" | "FOUR";
}

export const MessageBoxes: React.FC<MessageBoxesProps> = (props) => {
  const { role } = props;
